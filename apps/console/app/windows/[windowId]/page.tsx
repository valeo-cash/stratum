...
export default async function WindowDetailPage({ params }: { params: { windowId: string } }) {
  ...
  return (
    <div className="p-6 lg:p-10 max-w-[1200px]">
      <Link href="/windows" className="inline-flex items-center gap-2 text-sm text-[#6B7280] hover:text-[#0A0A0A] transition-colors mb-6">
        <ArrowLeft size={16} />
        Back to Windows
      </Link>

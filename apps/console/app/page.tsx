import { getStats, getReceipts } from "./lib/gateway";
    ...
    return (
      <div className="p-6 lg:p-10 max-w-[1200px]">
        ...
        <div className="mt-8 bg-[#FEF2F2] border border-[#FECACA] rounded-none p-6">
          ...
          <p className="text-[#6B7280] text-sm">Cannot connect to the Stratum Gateway. Make sure it is running at {process.env.GATEWAY_URL || "http://localhost:3100"}.</p>
        </div>
      </div>
    );
  }

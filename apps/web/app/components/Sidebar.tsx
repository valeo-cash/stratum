...
const navLinks = [
  ...
  { label: "Facilitators", href: "/facilitators", icon: "M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2z", chevron: true },
];
      ...
      <aside className="hidden lg:flex fixed left-0 top-0 bottom-0 w-[280px] flex-col bg-white  z-50">
        <div className="p-8">
          <Link href="/" className="flex items-center gap-3 mb-12">
            <img src="/logos/stratumlogo.png" alt="Stratum" className="h-12 object-contain" />
          </Link>

          ...
          <FadeIn>
            <div>
              ...
              <h2 className="text-[#0A0A0A] mb-6" style={{ fontSize: "clamp(1.6rem, 3vw, 2.2rem)", fontWeight: 500, lineHeight: 1.2 }}>
                We make you 1,000,000&times; more efficient
              </h2>
              ...
              <a href="/docs#facilitators" className="inline-flex items-center justify-center rounded-none px-6 py-3 text-sm font-medium bg-[#003FFF] text-white hover:bg-[#0033CC] transition-colors">
                Integrate as facilitator &rarr;
              </a>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={150}>
            <div className="rounded-none border border-[#E5E7EB] bg-[#FAFAFA] p-8 space-y-6">
              <div className="flex items-center justify-between">
                <span className="text-[#9CA3AF] text-sm">Weekly x402 settlements</span>
                <span className="text-[#0A0A0A] font-mono text-xl font-medium">500,000</span>
              </div>
              <div className="w-full h-px" />
              <div className="flex items-center justify-between">
                <span className="text-[#9CA3AF] text-sm">Batch instructions from Stratum</span>
                <span className="text-[#0A0A0A] font-mono text-xl font-medium">50</span>
              </div>
              <div className="w-full h-px" />
              <div className="flex items-center justify-between">
                <span className="text-[#9CA3AF] text-sm">Your infrastructure cost reduction</span>
                <span className="text-[#059669] font-mono text-xl font-medium">10,000&times;</span>
              </div>
            </div>
          </FadeIn>
        </div>
